...
class NewVersion {
  ...
  Future<VersionStatus> getVersionStatus() async {
    ...
    switch (Theme.of(context).platform) {
      case TargetPlatform.android:
        ...
        versionStatus =
            await _getAndroidStoreVersion(id, versionStatus) as VersionStatus;
        break;
      case TargetPlatform.iOS:
        final id = iOSId ?? packageInfo.packageName;
        versionStatus =
            await _getiOSStoreVersion(id, versionStatus) as VersionStatus;
        break;
      default:
  ...
  _getiOSStoreVersion(String id, VersionStatus versionStatus) async {
    ...
    versionStatus.storeVersion = jsonObj['results'][0]['version'].toString();
    versionStatus.appStoreLink =
        jsonObj['results'][0]['trackViewUrl'].toString();
    return versionStatus;
  }
